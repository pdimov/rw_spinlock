        ...
        for( ;; )
        {
            for( int k = 0; k < spin_count; ++k )
            {
                ...
                else
                {
                    ...
                    std::uint32_t newst = st | 0x40000000;
...

            {
                ...
                for( ;; )
                {
                    ...
                    else
                    {
                        ...
                        std::uint32_t newst = st & ~0x40000000u;
